...
@torch.no_grad()
def gen_retrieval(input_path, save_path, dataset_name, model_name, layer, resize, knn, vis):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-name", type=str, default="mvtec",
                        choices=["mvtec", "mvtec_3d", "btad", "mvtec_anomaly_detection"],
                        help="dataset name")
    ...
    mlflow.set_experiment("CPR_retrieval")
    ...
    with mlflow.start_run(run_name=f"{args.pretrained_model}_{args.layer}_{args.resize}"):
        ...
        gen_retrieval(args.data_dir, args.log_path, args.dataset_name, args.pretrained_model, args.layer, args.resize, args.k_nearest, args.vis)
